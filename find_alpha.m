function [al_act, iW] = find_alpha(L,g,w_act,d_act,c1,c2,kmaxBLS,epsal,al_ant,k,wk,d_ant,ialmax,sg_ga2,sg_al0,kmax,isd)
    iW = 4;
    if isd == 7
        ...
        elseif ialmax == 2, alpham = 2 * (L(w_act) - L(wk(:, k - 1))) / (g(w_act)' * d_act);
        end
